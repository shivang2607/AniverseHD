...
export const metadata = {
  title: {
    ...
    default:
      "AniverseHD : Stream Anime, Create & Share Watchlists - AniverseHD",
  },
  icons: "/logo-teal-stretched.png",
  description:
    "Stream your favorite anime in HD, create and share personalized watchlists, and get smart recommendations. Explore a world of anime with AniverseHD.",
  keywords: [
    "anime streaming",
    "anime watchlist",
