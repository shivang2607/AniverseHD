              ...
              >
                ...
                <div className=" content flex flex-col   mt-auto md:m-auto mb-12 text-base gap-4 md:gap-6 w-2/3">
                  ...
                  <div className="reroute flex md:gap-6 gap-3 items-center mt-5">
                    <Link href={`/watch/#?provider=zoro`} className="rounded-lg p-2 text-nowrap  md:text-base text-sm gap-1 bg-primary-600 md:gap-2 items-center flex text-cbg-100 "><FaPlayCircle/>Watch Now</Link>
