...
export default function RangeSlider({heading, min=0, max=10, step=0.5, score=true}) {
    const [range, setRange] = useState([6.5, 10.0]);

    const handleRangeChange = (values) => {
      setRange([values[0].toFixed(1), values[1].toFixed(1)]);
    };
  ...
  return (
    <div className="score my-4 flex flex-col gap-4 p-4 bg-cbg-100 rounded-md">
          ...
          <Slider
            ...
            styles={{ track: { backgroundColor: "#3182ce", height: "6px" },
                      handle: {
                        borderColor: "#3182ce",
