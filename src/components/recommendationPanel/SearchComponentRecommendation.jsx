// components/RecommendationSearchComponent.js
"use client";
...
const RecommendationSearchComponent = ({  onAnimeSelect }) => {
            ...
            {loading ? (
              ...
              <>
                {searchRes?.map((anime) => {
                  ...
                  return (
                    <div
                      className="flex result-card-container border-y-[1px] border-gray-500 hover:text-[whitesmoke] rounded-sm cursor-pointer hover:bg-cbg-400 gap-3 px-1 py-2 text-white"
                      key={anime?.id}
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2">
                        <span className="line-clamp-1 text-left text-ellipsis">
                          {title_english || "NA"}
                        </span>

                        <div className="metadata flex text-xs gap-2 items-center text-sky-300">
                          <span className="flex gap-1">
                            <b className="flex items-center text-gray-300">
                              &bull;
                            </b>
              ...
              <div className="text-gray-200 flex mx-auto">
                No Results found !!
              </div>
            )}
          </div>
